...
public class InputProcess {
        ...
        boolean inputValid(String s) {
            ...
            return isNumberOrOpe(operation) && isOpePosRight(operation) && isLogNeg(operation) && isDivisorZero(operation) && isValidparentheses(operation);
        }
        ...
        private boolean isOpePosRight(ArrayList<Token> ac) {
            Token t0 = ac.get(0);
            int i0 = t0.getValue();
